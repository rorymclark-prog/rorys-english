...
export default function AppearanceSettings() {
  ...
  return <div className="space-y-6">
    ...
    </div><p className="mt-2 text-xs text-navy-soft dark:text-navy-mist">Light is the default. Choose Dark yourself, or System to follow your device’s appearance, including its evening schedule.</p></fieldset>
